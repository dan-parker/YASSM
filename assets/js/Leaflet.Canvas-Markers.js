    ...
    t.exports = function(t) {
        var n = (t.Layer ? t.Layer : t.Class).extend({
            ...
            onAdd: function(t) {
            	...
            	if (map._zoomAnimated) {t.on('zoomanim', this._animateZoom, this);}		
            },
            onRemove: function(t) {
            ...
            _animateZoom: function(t) {
                ...
                var o = this._map._latLngBoundsToNewLayerBounds(this._map.getBounds(), t.zoom, t.center).min;
